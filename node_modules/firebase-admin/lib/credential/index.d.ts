 ...
 */
import { Credential as TCredential, applicationDefault as applicationDefaultFn, cert as certFn, refreshToken as refreshTokenFn } from 'firebase-admin/appin/appin/appin/app';
export { ServiceAccount, GoogleOAuthAccessToken } from 'firebase-admin/appin/appin/appin/app';
